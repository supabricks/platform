...
| An MCP client doesn't see sspc | missing GET leg or wrong client config | `curl -N localhost:30080/mcp` must hold an SSE stream open; check the client's MCP config path |
