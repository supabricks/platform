#!/usr/bin/env python3
"""Summarize original and predeclared follow-up 16:50 pairs without replacement."""
import json
...
for block in ('.','low-load-followup'):
    ...
    for pair in record['pairs']:
        if (pair['pair']['cpus'],pair['pair']['rate'])!=(16,50):
            continue
        ...
        pairs.append(row)
result=dict(scope='All six 16:50 pairs, including the original freshness miss; no replacement or pooled row percentiles',pairs=pairs)
