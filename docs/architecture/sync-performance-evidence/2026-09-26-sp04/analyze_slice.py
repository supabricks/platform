"""Recompute SP04 paired summaries; no independent-trial confidence claim."""
import json
from pathlib import Path
import statistics

METRICS = ('lag_p95_ms', 'lag_p99_ms', 'cpu_cores', 'peak_memory_bytes', 'source_rows_s', 'baseline_rows_s', 'apply_merge_ms', 'apply_run_ms')
