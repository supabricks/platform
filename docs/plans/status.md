...
Reconciled 2026-09-25. [Platform #86](https://github.com/supabricks/platform/pull/86)
tracks SY08 integration; [#89](https://github.com/supabricks/platform/pull/89)
merged profiling, retained CPU-scaling evidence, the SP00–SP12 plan and CI repairs
into that branch. Source integration does not qualify a new archive. Earlier
fresh-build latency/console failures and subsequent fixes remain in the SY08 ledger;
the historical exact-alpha.36 receipts below retain their original scope.
...
identities, combined R04/SY08 evidence, the ingress receipt and measured limits.
[UC09.8 / alpha.35](../architecture/uc098-governed-release.md) remains historical evidence.
...
| A00–A03 | Merged: frozen exports, atomic Delta/Parquet epochs and Sail sessions | Read-only analytical SQL over explicit snapshots; triggered/continuous incrementality is delivered by SY00–SY08 |
...
| SY00–SY08 | SY00 probe complete: Linux/macOS exact-alpha.35 checks passed; SY01 managed snapshot policies/scheduling implemented; [SY02 durable capture merged (#80)](https://github.com/supabricks/platform/pull/80); [SY03 incremental epochs merged (#81)](https://github.com/supabricks/platform/pull/81); [SY04 local triggered sync merged (#82)](https://github.com/supabricks/platform/pull/82); [SY05 bounded local continuous sync merged (#83)](https://github.com/supabricks/platform/pull/83); [SY06 shared controls and governed service authority](../architecture/sy06-sync-surfaces.md) implemented (service-bound capture and immutable epoch views; [platform #84 merged](https://github.com/supabricks/platform/pull/84), [console #14 merged](https://github.com/supabricks/console/pull/14)); [SY07 recovery and storage maintenance](../architecture/sy07-sync-hardening.md) merged in [#85](https://github.com/supabricks/platform/pull/85); required checks and both Linux/macOS native suites passed; [SY08 exact installed qualification](../architecture/sy08-installed-sync.md) passed all 33 release jobs for alpha.36 in #86 | [Managed analytical synchronization](analytical-sync-implementation.md): PostgreSQL → analytics first; incremental triggered/continuous modes, bounded capture and recovery; [SY00 decisions](../architecture/sy00-capture-probe.md), [SY01 contract](../architecture/sy01-managed-snapshots.md), [SY02 contract](../architecture/sy02-durable-capture.md), [SY03 contract](../architecture/sy03-incremental-epochs.md), [SY04 contract](../architecture/sy04-triggered-sync.md), [SY05 contract](../architecture/sy05-continuous-sync.md); reverse sync deferred |
| SP00–SP12 performance follow-up | SP00 merged in [#95](https://github.com/supabricks/platform/pull/95); SP01 merged in [#97](https://github.com/supabricks/platform/pull/97); SP02 merged in [#103](https://github.com/supabricks/platform/pull/103); SP03a merged in [#109](https://github.com/supabricks/platform/pull/109); SP03b merged in [#111](https://github.com/supabricks/platform/pull/111); SP04 merged in [#117](https://github.com/supabricks/platform/pull/117); SP05 assessed, tuning deferred; SP06–SP12 planned | [SP00 report](../architecture/sp00-reproducible-comparisons.md); [SP01 report](../architecture/sp01-journal-contention-recovery.md): 24 mandatory + six follow-up trials per slice; SP01 removes observed BUSY resync failures but does not raise throughput. [SP02 report](../architecture/sp02-durable-capture-groups.md): 24 mandatory trials, 24 profiler controls, 33 component trials; capture ~30 → 343–344 transactions/s and overload completion 0/6 → 6/6 at 684–689 actual changed rows/s. [SP03a report](../architecture/sync-performance-sp03a.md): both installed platforms already load fixed SQLite, 24 mandatory + 18 control + nine component trials pass; no upgrade or speedup. [SP03b report](../architecture/sync-performance-sp03b.md): capture WAL/FULL improves achieved overload input 8–9%, with measured CPU and physical-storage costs. [SP04 report and evidence](../architecture/sync-performance-sp04.md). [SP05 assessment](../architecture/sync-performance-sp05.md): short profiles do not establish a maintenance bottleneck; no runtime change or speedup claim; repeated reclamation/rotation/pin pressure remains required in SP11. [Implementation plan](sync-performance-implementation.md): per-slice measured contributions toward sustained 1,000 changed rows/s and five-second p95 in a declared local profile; no expanded release claim |
