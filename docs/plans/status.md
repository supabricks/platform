...
| SY00–SY08 | SY00 probe complete: Linux/macOS exact-alpha.35 checks passed; SY01 managed snapshot policies/scheduling implemented for review; SY02–SY08 planned | [Managed analytical synchronization](analytical-sync-implementation.md): PostgreSQL → analytics first; incremental triggered/continuous modes, bounded capture and recovery; [SY00 decisions](../architecture/sy00-capture-probe.md), [SY01 contract](../architecture/sy01-managed-snapshots.md); reverse sync deferred |
