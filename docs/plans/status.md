...
UC08 is merged and qualified. UC09 is [scoped for a shared Linux server](uc09-governed-implementation.md); IAM00 feasibility is merged in #66; UC09.1 identity/login is merged in #67; [UC09.2 authorization](../architecture/uc092-authorization.md) is implemented for review; governed product integration remains open.
