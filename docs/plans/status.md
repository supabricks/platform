...
| SY00–SY08 | SY00 probe implemented for qualification; SY01–SY08 planned | [Managed analytical synchronization](analytical-sync-implementation.md): PostgreSQL → analytics first; incremental triggered/continuous modes, bounded capture and recovery; [SY00 decisions](../architecture/sy00-capture-probe.md); reverse sync deferred |
