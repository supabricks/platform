...
| SP00–SP12 performance follow-up | SP00 merged in [#95](https://github.com/supabricks/platform/pull/95); SP01 merged in [#97](https://github.com/supabricks/platform/pull/97); SP02 implementation and measurement in progress; SP03–SP12 planned | [SP00 report](../architecture/sp00-reproducible-comparisons.md); [SP01 report](../architecture/sp01-journal-contention-recovery.md): 24 mandatory + six follow-up trials per slice; SP01 removes observed BUSY resync failures but does not raise throughput. [Implementation plan](sync-performance-implementation.md): per-slice measured contributions toward sustained 1,000 changed rows/s and five-second p95 in a declared local profile; no expanded release claim |
