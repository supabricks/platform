...
| SY00–SY08 | SY00 probe complete: Linux/macOS exact-alpha.35 checks passed; SY01 managed snapshot policies/scheduling implemented; [SY02 durable capture merged (#80)](https://github.com/supabricks/platform/pull/80); [SY03 incremental epochs (#81)](https://github.com/supabricks/platform/pull/81); SY04 local triggered sync implemented for review; SY05–SY08 planned | [Managed analytical synchronization](analytical-sync-implementation.md): PostgreSQL → analytics first; incremental triggered/continuous modes, bounded capture and recovery; [SY00 decisions](../architecture/sy00-capture-probe.md), [SY01 contract](../architecture/sy01-managed-snapshots.md), [SY02 contract](../architecture/sy02-durable-capture.md), [SY03 contract](../architecture/sy03-incremental-epochs.md), [SY04 contract](../architecture/sy04-triggered-sync.md); reverse sync deferred |
