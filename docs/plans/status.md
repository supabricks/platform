...
Reconciled 2026-09-24. [Platform #86](https://github.com/supabricks/platform/pull/86)
...
| SP00–SP12 performance follow-up | SP00 implemented and measured in [#95](https://github.com/supabricks/platform/pull/95), pending merge; SP01–SP12 planned | [SP00 report](../architecture/sp00-reproducible-comparisons.md): 24 mandatory + six follow-up trials, keep for reliability/enabling with no speedup. [Implementation plan](sync-performance-implementation.md): per-slice measured contributions toward sustained 1,000 changed rows/s and five-second p95 in a declared local profile; no expanded release claim |
