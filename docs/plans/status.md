...
| SY00–SY08 | SY00 probe complete: Linux/macOS exact-alpha.35 checks passed; SY01 managed snapshot policies/scheduling implemented; SY02 durable capture implemented; SY03 incremental epochs implemented for review; SY04–SY08 planned | [Managed analytical synchronization](analytical-sync-implementation.md): PostgreSQL → analytics first; incremental triggered/continuous modes, bounded capture and recovery; [SY00 decisions](../architecture/sy00-capture-probe.md), [SY01 contract](../architecture/sy01-managed-snapshots.md), [SY02 contract](../architecture/sy02-durable-capture.md), [SY03 contract](../architecture/sy03-incremental-epochs.md); reverse sync deferred |
