...
| Open-source Unity Catalog | Planned; UC00 is the first slice | [UC00–UC09 plan](unity-catalog-implementation.md): local catalog workflow first; governed access depends on IAM and isolation |
