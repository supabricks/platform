...
| SY00–SY08 | Planned, not implemented | [Managed analytical synchronization](analytical-sync-implementation.md): PostgreSQL → analytics first; incremental triggered/continuous modes, bounded capture and recovery; reverse sync deferred |
