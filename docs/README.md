...
| Compare measured synchronization performance | [SP02 comparison and contribution](architecture/sp02-durable-capture-groups.md); [SP03a SQLite qualification](architecture/sync-performance-sp03a.md) |
