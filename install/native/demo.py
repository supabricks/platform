...
FILES = ('DEMO.md', 'examples/console/sales.csv', 'examples/console/sales.ipynb', 'PROJECT-PORTABILITY.md', 'PROJECT-DATA.md', 'PROJECT-CREATION.md', 'CATALOG-DEMO.md', 'GOVERNED-SERVER.md')
SALES = b'id,amount\n1,10\n2,20\n'
