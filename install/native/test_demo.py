...
class DemoTest(unittest.TestCase):
    def setUp(self):
        ...
        for name in FILES:
            source=repo/({'DEMO.md':'docs/handbook/local-demo.md','PROJECT-PORTABILITY.md':'docs/handbook/project-portability.md','PROJECT-CREATION.md':'docs/handbook/project-creation.md', 'PROJECT-DATA.md':'docs/handbook/project-data.md'}.get(name,name))
